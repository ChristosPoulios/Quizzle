 ...
 * 
 * Features a MessagePanel above the buttons that spans the full width. Used as
 * base class for all button panels in the application.
 * 
...
public class MyButtonPanel extends JPanel implements GUIConstants {
	...
	/**
	 * Constructs the ButtonPanel with custom button names and integrated
	 * MessagePanel.
	 *
	...
	public MyButtonPanel(String btnName1, String btnName2, String btnName3) {
	    ...
	    messagePanel.setBorder(BorderFactory.createEmptyBorder(0, 10, 0, 0));
